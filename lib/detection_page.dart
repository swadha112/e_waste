...
class _DetectionPageState extends State<DetectionPage> {
  ...
  Future<void> _performDetection() async {
    ...
    final url = Uri.parse(
        'https://detect.roboflow.com/$roboflowModelId?api_key=$roboflowApiKey&confidence=0.3');
        ...
        "messages": [
          {
            "role": "system",
            "content":
            "Provide detailed information on the object: $objectName using model: $modelName."
          }
        ],
        "temperature": 0.7,
        "max_tokens": 256,
              ...
              _useTextInput
                ...
                children: [
                  TextField(
                      ...
                      decoration:
                      InputDecoration(labelText: 'Object Name')),
                  TextField(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  // Detection container with Lottie animation and Perform Detection button.
                  Container(
